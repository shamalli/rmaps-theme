...
<footer class="rmaps-site-footer" role="contentinfo">
	<div class="rmaps-container rmaps-footer-inner">
		<div class="rmaps-footer-brand">
			...
			<p class="rmaps-footer-tagline">
				<?php esc_html_e( 'Rocket Maps — fast, searchable maps for WordPress.', 'rmaps-theme' ); ?>
			</p>
		</div>

		<nav class="rmaps-footer-nav" aria-label="<?php esc_attr_e( 'Footer', 'rmaps-theme' ); ?>">
			<?php

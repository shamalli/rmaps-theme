...
<article id="page-<?php the_ID(); ?>" <?php post_class( 'rmaps-theme-page rmaps-theme-page-fullwidth rmaps-theme-front-page' ); ?>>
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post();
		...
		<?php else : ?>
			<section class="rmaps-theme-hero">
				<div class="rmaps-theme-container">
					<h1 class="rmaps-theme-hero-title"><?php bloginfo( 'name' ); ?></h1>
					<p class="rmaps-theme-hero-tagline"><?php bloginfo( 'description' ); ?></p>
					<p class="rmaps-theme-hero-cta">
						<a class="rmaps-theme-button rmaps-theme-button-primary" href="<?php
						...
						<a class="rmaps-theme-button rmaps-theme-button-ghost" href="#features">
